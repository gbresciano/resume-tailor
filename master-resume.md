...
- ~28M MAU
- +30% MAU growth (post-Goodnotes 6 launch)
- 2x revenue (post-subscription model switch)
...
| --------- | ------------------- |
| Goodnotes | ~28M MAU            |
| Goodnotes | +30% MAU growth     |
| Goodnotes | 2x revenue          |
| Loop      | +18% MAU            |
| Loop      | +24% paying users   |
| Loop      | Activation 8% → 17% |
